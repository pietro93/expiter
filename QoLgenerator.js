...
fetch('https://expiter.com/dataset.json', {method:"Get"})
    ...
    .then(function (data) {
        ...
        '<nav id="navbar"></nav>'+
            '<div class="hero" style="background-image:url(\'https://expiter.com/img/blog/vivere-a-'+en(province.Name)+'.webp\')" '+'title="What is life in '+en(province.Name)+', Italy like?"'+'></div>'+
    ...
    function newPage(province, $){
        ...
        '<img title="'+en(province.Name)+'" load="lazy" src="'+
        'https://expiter.com/img/blog/vita-a-'+en(province.Name)+'.webp" '+
