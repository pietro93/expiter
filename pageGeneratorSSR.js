  ...
  function getData(province){
    for (let i=0;i<dataset.length;i++){
      ...
      function getInfo(province){
        ...
        "</br></br>"+
        "<a href='https://expiter.com/it/comuni/provincia-di-"+province.Name.replace(/\s+/g,"-").replace("'","-").toLowerCase()+"/'>"+"The larger "+province.Name+" metropolitan area comprises <b>"+province.Towns+" towns</a></b> (comuni) and covers an area of "+province.Size.toLocaleString()+" km<sup>2</sup>. "
