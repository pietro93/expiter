...
fetch('https://expiter.com/dataset.json', {method:"Get"})
    ...
    .then(function (data) {
        ...
        for (let i = 0; i < 107; i++){
            ...
            let seoDescription='Informations sur la vie à '+fr(province.Name)+' '+'('+fr(province.Region)+') pour les expatriés, les étudiants et les nomades digitaux. '+fr(province.Name)+' qualité de vie, coût de la vie, sécurité et autres infos utiles.'
            ...
            '<link rel="alternate" hreflang="en" href="https://expiter.com/'+fileName.replace('fr/','')+'/" />'+
            '<link rel="alternate" hreflang="fr" href="https://expiter.com/'+fileName+'/" />'+
	        ...
	        '<meta name="keywords" content="vivre à '+fr(province.Name)+', '+fr(province.Name)+' nomades digitaux,'+fr(province.Name)+' qualité de vie,'+fr(province.Name)+' vie nocturne" />'+
        ...
        '<nav id="navbar"></nav>'+
            '<div class="hero" style="background-image:url(\'https://expiter.com/img/'+province.Abbreviation+'.webp\')" '+'title="Provincia di '+fr(province.Name)+'"'+'></div>'+
...
let parsedData = fs.readFileSync('temp/fr-parsedDataAbout'+province.Name+'.txt','utf8');
...
console.log('error: ' + err);
        ...
        function newPage(province, $){
            ...
            let map =
            '<figure>'+
            '<img alt="Carte de la province de '+fr(province.Name)+' dans '+fr(province.Region)+'"'+
          ...
          function getInfo(province){
            ...
            info.overview="La province de "+fr(province.Name)+" est la <b>"+province.SizeByPopulation+"e plus grande province italienne par population</b> avec <b>"+province.Population.toLocaleString()+" habitants</b>, dans la région <b>"+fr(province.Region)+"</b>. "+
            (facts[name].overview?facts[name].overview:"")+
            "</br></br>"+
            "<a href='https://expiter.com/fr/communes/province-de-"+fr(province.Name).replace(/\s+/g,"-").replace("'","-").toLowerCase()+"/'>"+"L'aire métropolitaine de "+fr(province.Name)+" comprend <b>"+
            ...
            info.climate="La province de "+fr(province.Name)+" reçoit en moyenne <b>"+province.SunshineHours+" heures de soleil</b> par mois, soit "+province.SunshineHours/30+" heures de lumière par jour."+
            ...
            "</br></br>"
            info.lgbtq="<b>"+fr(province.Name)+" est "+(province['LGBT-friendly']>7.9?"l'une des provinces les plus LGBTQ-friendly d'Italie":(province['LGBT-friendly']>6?"assez LGBTQ-friendly selon les normes italiennes":"pas particulièrement LGBTQ-friendly par rapport aux autres provinces italiennes"))+
            ...
            +"<h3>Combien d'universités y a-t-il à "+fr(province.Name)+"?</h3>";
            ...
            info.weather=(province.WeatherWidget?'<center><h3>Climat</h3><a class="weatherwidget-io" href="https://forecast7.com/fr/'+province.WeatherWidget+'" data-label_1="'+name+'" data-label_2="'+region.Name+'"'+
        ...
        function populateData(data){
            ...
            for (let i = 0; i < 107; i++) {
              ...
              '<figure class="column is-3 related"><a href="https://expiter.com/fr/province/'+province.Name.replace(/\s+/g,"-").replace("'","-").toLowerCase()+'/">'+
