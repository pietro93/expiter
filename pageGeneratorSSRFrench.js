...
function renderPage(province, fileName) {
    ...
    return nunjucks.render('pages/province-fr.njk', {
        ...
        tabRows,
        toc,
        overview: '<div class="province-hero" role="img" aria-label="Province de ' + fr(province.Name) + '" style="background-image:url(\'https://expiter.com/img/' + province.Abbreviation + '.webp\')"></div>' + map + pb.wrapParagraphs(info.overview) + (info.disclaimer || '') + (info.map || ''),
