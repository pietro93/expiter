...
function renderPage(province, fileName) {
    ...
    return nunjucks.render('pages/province-de.njk', {
        ...
        tabRows,
        toc,
        overview: '<div class="province-hero" role="img" aria-label="Provinz ' + de(province.Name) + '" style="background-image:url(\'https://expiter.com/img/' + province.Abbreviation + '.webp\')"></div>' + map + pb.wrapParagraphs(info.overview) + (info.disclaimer || '') + (info.map || ''),
