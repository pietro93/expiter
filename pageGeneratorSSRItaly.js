...
fetch('https://expiter.com/dataset.json', {method:"Get"})
    ...
    function renderPage(province, fileName){
        ...
        return nunjucks.render('pages/province-it.njk', {
            ...
            tabRows,
            toc,
            overview: '<div class="province-hero" role="img" aria-label="Provincia di '+province.Name+'" style="background-image:url(\'https://expiter.com/img/'+province.Abbreviation+'.webp\')"></div>' + map + pb.addBreaks(info.overview) + (info.disclaimer||'') + (info.map||''),
