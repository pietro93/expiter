...
'</script>'
let GSC = '<!-- Google Search Console Tracker --><meta name="google-site-verification" content="4sOxlmGkQBkLLrrnRU2a4dAKUnhKxU3-VzFaRrfvGwk" />'
$('head').append(adSense+analytics+hotJar+GSC)
}
)